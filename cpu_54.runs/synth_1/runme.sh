...
HD_PWD='D:/computer_composition/cpu_54/cpu_54.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log postsim_top.vds -m64 -mode batch -messageDb vivado.pb -notrace -source postsim_top.tcl
